...
LambdaXl = Parameter(name = 'LambdaXl',
                     nature = 'external',
                     type = 'real',
                     value = 1000,
