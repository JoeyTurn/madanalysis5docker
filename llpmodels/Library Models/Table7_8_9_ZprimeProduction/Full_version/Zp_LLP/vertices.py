...
V_12 = Vertex(name = 'V_12',
              particles = [ P.a, P.a, P.S2__tilde__ ],
              color = [ '1' ],
              lorentz = [ L.VVS2 ],
...
V_40 = Vertex(name = 'V_40',
              particles = [ P.e__plus__, P.e__minus__, P.s2 ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_147})

V_41 = Vertex(name = 'V_41',
              particles = [ P.mu__plus__, P.mu__minus__, P.s2 ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
...
V_46 = Vertex(name = 'V_46',
              particles = [ P.x2__tilde__, P.x1, P.a, P.a ],
              color = [ '1' ],
              lorentz = [ L.FFVV1 ],
              couplings = {(0,0):C.GC_76})

V_47 = Vertex(name = 'V_47',
              particles = [ P.x3__tilde__, P.x1, P.S2__tilde__ ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_16})

V_48 = Vertex(name = 'V_48',
              particles = [ P.x1__tilde__, P.x2, P.a, P.a ],
              color = [ '1' ],
              lorentz = [ L.FFVV1 ],
              couplings = {(0,0):C.GC_76})

V_49 = Vertex(name = 'V_49',
              particles = [ P.x3__tilde__, P.x2, P.S1__tilde__ ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_14})

V_50 = Vertex(name = 'V_50',
              particles = [ P.x1__tilde__, P.x3, P.s2 ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_16})

V_51 = Vertex(name = 'V_51',
              particles = [ P.x2__tilde__, P.x3, P.s1 ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_14})
...
V_55 = Vertex(name = 'V_55',
              particles = [ P.e__plus__, P.e__minus__, P.x2__tilde__, P.x1 ],
              color = [ '1' ],
              lorentz = [ L.FFFF1 ],
              couplings = {(0,0):C.GC_75})

V_56 = Vertex(name = 'V_56',
              particles = [ P.mu__plus__, P.mu__minus__, P.x2__tilde__, P.x1 ],
              color = [ '1' ],
              lorentz = [ L.FFFF1 ],
              couplings = {(0,0):C.GC_77})

V_57 = Vertex(name = 'V_57',
              particles = [ P.ta__plus__, P.ta__minus__, P.x2__tilde__, P.x1 ],
              color = [ '1' ],
              lorentz = [ L.FFFF1 ],
              couplings = {(0,0):C.GC_78})

V_58 = Vertex(name = 'V_58',
              particles = [ P.e__plus__, P.e__minus__, P.x1__tilde__, P.x2 ],
              color = [ '1' ],
              lorentz = [ L.FFFF1 ],
              couplings = {(0,0):C.GC_75})

V_59 = Vertex(name = 'V_59',
              particles = [ P.mu__plus__, P.mu__minus__, P.x1__tilde__, P.x2 ],
              color = [ '1' ],
              lorentz = [ L.FFFF1 ],
              couplings = {(0,0):C.GC_77})

V_60 = Vertex(name = 'V_60',
              particles = [ P.ta__plus__, P.ta__minus__, P.x1__tilde__, P.x2 ],
              color = [ '1' ],
              lorentz = [ L.FFFF1 ],
              couplings = {(0,0):C.GC_78})
...
V_121 = Vertex(name = 'V_121',
               particles = [ P.d__tilde__, P.d, P.S2__tilde__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_144})

V_122 = Vertex(name = 'V_122',
               particles = [ P.s__tilde__, P.s, P.S2__tilde__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_145})

V_123 = Vertex(name = 'V_123',
               particles = [ P.b__tilde__, P.b, P.S2__tilde__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_146})

V_124 = Vertex(name = 'V_124',
               particles = [ P.e__plus__, P.e__minus__, P.S2__tilde__ ],
               color = [ '1' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_147})

V_125 = Vertex(name = 'V_125',
               particles = [ P.mu__plus__, P.mu__minus__, P.S2__tilde__ ],
               color = [ '1' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_148})

V_126 = Vertex(name = 'V_126',
               particles = [ P.ta__plus__, P.ta__minus__, P.S2__tilde__ ],
               color = [ '1' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_149})

V_127 = Vertex(name = 'V_127',
               particles = [ P.u__tilde__, P.u, P.S2__tilde__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_150})

V_128 = Vertex(name = 'V_128',
               particles = [ P.c__tilde__, P.c, P.S2__tilde__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_151})

V_129 = Vertex(name = 'V_129',
               particles = [ P.t__tilde__, P.t, P.S2__tilde__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_152})
...
V_145 = Vertex(name = 'V_145',
               particles = [ P.zp, P.S1__tilde__, P.s2 ],
               color = [ '1' ],
               lorentz = [ L.VSS1 ],
               couplings = {(0,0):C.GC_13})

V_146 = Vertex(name = 'V_146',
               particles = [ P.zp, P.s1, P.S2__tilde__ ],
               color = [ '1' ],
               lorentz = [ L.VSS1 ],
               couplings = {(0,0):C.GC_13})

V_147 = Vertex(name = 'V_147',
               particles = [ P.zp, P.S2__tilde__, P.s2 ],
               color = [ '1' ],
               lorentz = [ L.VSS1 ],
...
V_148 = Vertex(name = 'V_148',
               ...
               couplings = {(0,1):C.GC_23,(0,0):C.GC_24})

V_149 = Vertex(name = 'V_149',
               particles = [ P.c__tilde__, P.c, P.zp ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV1, L.FFV2 ],
               couplings = {(0,1):C.GC_25,(0,0):C.GC_26})

V_150 = Vertex(name = 'V_150',
               particles = [ P.d__tilde__, P.d, P.zp ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV1, L.FFV2 ],
               couplings = {(0,1):C.GC_27,(0,0):C.GC_28})

V_151 = Vertex(name = 'V_151',
               particles = [ P.s__tilde__, P.s, P.zp ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV1, L.FFV2 ],
               couplings = {(0,1):C.GC_29,(0,0):C.GC_30})

V_152 = Vertex(name = 'V_152',
               particles = [ P.t__tilde__, P.t, P.zp ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV1, L.FFV2 ],
               couplings = {(0,1):C.GC_31,(0,0):C.GC_32})
...
V_154 = Vertex(name = 'V_154',
               particles = [ P.x2__tilde__, P.x1, P.zp ],
               color = [ '1' ],
               lorentz = [ L.FFV1, L.FFV2 ],
               couplings = {(0,1):C.GC_17,(0,0):C.GC_18})

V_155 = Vertex(name = 'V_155',
               particles = [ P.x1__tilde__, P.x2, P.zp ],
               color = [ '1' ],
               lorentz = [ L.FFV1, L.FFV2 ],
               couplings = {(0,1):C.GC_17,(0,0):C.GC_18})

V_156 = Vertex(name = 'V_156',
               particles = [ P.x2__tilde__, P.x2, P.zp ],
               color = [ '1' ],
               lorentz = [ L.FFV1, L.FFV2 ],
               couplings = {(0,1):C.GC_19,(0,0):C.GC_20})

V_157 = Vertex(name = 'V_157',
               particles = [ P.x3__tilde__, P.x3, P.zp ],
               color = [ '1' ],
               lorentz = [ L.FFV1, L.FFV2 ],
               couplings = {(0,1):C.GC_21,(0,0):C.GC_22})
